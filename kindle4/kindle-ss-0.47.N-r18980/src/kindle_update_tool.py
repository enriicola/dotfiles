...
# $Id: kindle_update_tool.py 7496 2011-07-02 15:06:18Z NiLuJe $
# History:
...
if len(sys.argv)<3:
    ...
    try:
        opts, args = getopt.getopt(sys.argv[2:], "", ["k2", "k2i", "DX", "dx", "dxi", "DXi", "dxg", "DXg", "k3g", "k3w", "k3gb", "fd", "FD", "fb", "FB", "fb2", "FB2"])
    ...
    try:
        opts, args = getopt.getopt(sys.argv[2:], "", ["k2", "k2i", "DX", "dx", "DXi", "dxi", "DXg", "dxg", "k3g", "k3w", "k3gb", "sign", "ex", "fd", "FD", "fb", "FB", "fb2", "FB2"])
    except getopt.GetoptError:
        # print help information and exit:
        print "Unrecognised option: "
        usage()
